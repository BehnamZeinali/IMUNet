"""
This is the exact same code in https://github.com/Sachini/ronin/get_dataset.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('--list', type=str, default='list_data_behnam.txt', help='Path to a list file.')
    ...
    args = parser.parse_args()
    args.list = current_dir + '/list_data_tango.txt'
    ...
    for dataset in dataset_list:
        ...
        if os.path.exists(data_root + '/processed/data.csv') and not args.recompute:
            ...
            assert 194 < output_samplerate < 205, 'Wrong output sample rate: %f' % output_samplerate
