"""
This is the exact same code in https://github.com/Sachini/ronin/blob/master/source/model_resnet1d.py
...
if __name__ == '__main__':
    ...
    net = ResNet1D(_input_channel, _output_channel, BasicBlock1D, [2, 2, 2, 2],
